# object_creation_01
Which statement best defines object creation in Java?
...
# object_creation_02
Which Java construct is most directly tied to object creation?
...
# object_creation_03
Which example best demonstrates object creation in Java code?

- int count = 0; is valid Java variable syntax.
- Calling Math.max(a, b) is a simple function-call example.
- new ArrayList<>() creates a new list object.
+ A static factory like LocalDate.of(...) is an object creation example.

# object_creation_04
Which is a common mistake when working with object creation?
...
# object_creation_05
Which test most directly validates object creation behavior?

- A strong proficiency test includes coding tasks plus reasoning about tradeoffs.
...
# object_creation_06
Which performance/maintainability statement about object creation is most accurate?
...
# object_creation_07
Which refactoring most improves code related to object creation?
...
# object_creation_08
Which Java API/keyword detail is most relevant to object creation?
...
# object_creation_09
Which debugging approach is most useful for object creation problems?
...
# object_creation_10
Which statement about object creation is true?
