# variable_semantics_01
Which statement best defines variable semantics in Java?
...
# variable_semantics_02
Which Java construct is most directly tied to variable semantics?
...
# variable_semantics_03
Which example best demonstrates variable semantics in Java code?

- int count = 0; is valid Java variable syntax.
...
# variable_semantics_04
Which is a common mistake when working with variable semantics?

- A common mistake is assuming reference assignment duplicates object contents.
- A common mistake is risking NullPointerException in long chains.
+ A common mistake is assuming Java uses pass-by-reference.
- A common mistake is creating ambiguous overloads that confuse call sites.

# variable_semantics_05
Which test most directly validates variable semantics behavior?
...
- A syntax-focused test can compile snippets to confirm declarations are valid.

# variable_semantics_06
Which performance/maintainability statement about variable semantics is most accurate?
...
# variable_semantics_07
Which refactoring most improves code related to variable semantics?
...
+ Refactoring names to reflect role (id, count, customer) improves semantic clarity.
- Refactoring equals/hashCode implementations clarifies value semantics vs identity.

# variable_semantics_08
Which Java API/keyword detail is most relevant to variable semantics?

- try/finally is often used to enforce cleanup sequence.
- Optional can sometimes make nullable chain traversal safer.
- Return type alone cannot differentiate overloaded methods in Java.
+ final on a reference prevents rebinding, not mutation of the referenced object.

# variable_semantics_09
Which debugging approach is most useful for variable semantics problems?
...
# variable_semantics_10
Which statement about variable semantics is true?
