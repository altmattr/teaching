...
Inheritance and Overloading. Before class, read Learning Java Chapter 6 (Subclassing and Inheritance, Interfaces, Inner Classes — just the introductory part). The lecture covered `extends` and `implements`, the diamond problem, shadowing, method overriding and overloading, and UML class diagrams. By now your team should have a more complex design and some real code to work with — this week's EPIC activity depends on it. In the EPIC activity, your team will look at the code you've built so far and find places where inheritance can reduce duplication. Where do two or more classes share fields or methods that a superclass could hold? Where would `@Override` let you specialise a behaviour, or overloading provide a cleaner interface? This is a log book class, so take 25 minutes to sketch your inheritance hierarchy as UML and note which fields and methods moved to the superclass and why. Bring your logbook and be ready to explain one design decision you're unsure about.
